...
It includes a method to calculate the area, which is expected to be implemented by subclasses.
It raises an exception if the method is not implemented, enforcing that subclasses must provide their own implementation.
"""
